...
export default function AccountPage() {
  ...
  const whatsappUrl = `https://wa.me/${STORE_WHATSAPP_NUMBER}?text=Hi%20Gadgetion,%20I%20need%20help%20with%20my%20account.`;
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-20 flex items-center justify-center">
        <div className="bg-white p-8 md:p-12 rounded-[2.5rem] border border-gray-100 shadow-xl text-center max-w-lg w-full">
          ...
          <h1 className="text-3xl font-black text-gray-900 mb-4 tracking-tight">Your Account</h1>
          <p className="text-gray-500 mb-8 text-lg">
            Account features are under development. Soon you'll be able to manage your orders and details here.
          </p>
          <a
            href={whatsappUrl}
            target="_blank"
